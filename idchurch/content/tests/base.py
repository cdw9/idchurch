...
def setup_product():
    ...
    import idchurch.content
    zcml.load_config('configure.zcml', idchurch.content)
    ...
    ztc.installPackage('idchurch.content')
...
setup_product()
ptc.setupPloneSite(products=['idchurch.content'])
